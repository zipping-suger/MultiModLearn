...
MULTI_PATH_WAYPOINTS_1 = (
    ...
    (
        (0, 0),
        (0.5*BOUNDS, 0.5*BOUNDS),
        (BOUNDS, BOUNDS),
        (1.5*BOUNDS, 1.5*BOUNDS),
        (2 * BOUNDS, 2 * BOUNDS),
    ),
    (
        (0, 0),
...
class PathGenerator:
    def __init__(self, waypoints, step_size = 1, num_draws=10, noise_scale=0.25, traj_len=None):
        """
